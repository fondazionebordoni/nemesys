...
#
#     from nemesys import metadata
#
# However, when we do this, we also import `nemesys/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'nemesys_cli = nemesys.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'nemesys_gui = nemesys.gui:entry_point'
        # ]
    }
)
