...
class TestCheckhost(unittest.TestCase):
    ...
    def test_old_technicolor(self):
        res = nemesys.checkhost.filter_out_technicolor(HOSTS_OLD_TECHNICOLOR)
        self.assertEqual(1, res)

    def test_new_technicolor(self):
        res = nemesys.checkhost.filter_out_technicolor(HOSTS_NEW_TECHNICOLOR)
        self.assertEqual(1, res)

    def test_not_technicolor(self):
        res = nemesys.checkhost.filter_out_technicolor(HOSTS_NOT_TECHNICOLOR)
