...
class Analyzer(Thread):
    ...
    def run(self):
        ...
        for i in range(0,1000):
            ...
            analyzer.analyze(analyzer_data['py_byte_array'],analyzer_data['block_size'],analyzer_data['blocks_num'])
...
getdev('192.168.88.44')

print "\nThird Request: Device by IP assigned to the machine"

getdev('192.168.88.10')

print "\nInitialize Sniffer And Analyzer...."

mysniffer=Sniffer('wlan0',44*1024,150,1,1,1)
myanalyzer=Analyzer('192.168.88.10','194.244.5.206',1)
