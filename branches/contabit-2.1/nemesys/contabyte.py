...
IP_V4_RF           = 0x8000         # reserved
IP_V4_DF           = 0x4000         # don't fragment
IP_V4_MF           = 0x2000         # more fragments (not last frag)
IP_V4_OFFMASK      = 0x1fff         # mask for fragment offset
...
{                                  \
'ipv4Ver'       : IP_V4_VER,       \
'ipv4HdrLen'    : IP_V4_HDR_SIZE,  \
'ipv4ToS'       : None,            \
'ipv4TotLen'    : IP_V4_HDR_SIZE,  \
'ipv4Id'        : None,            \
'ipv4Offset'    : None,            \
'ipv4Ttl'       : IP_TTL_MIN,      \
'ipv4PayType'   : None,            \
