...
TECHNICOLOR_MAC_REGEX = ('^F..94.E3|^F..91.14|^F..52.8D|^F..C1.14|'
                         ...
                         '^D..EB.69|^D..B9.2F|^D..35.1D|^D..B2.C4|^D..8A.91|^D..5A.00|'
                         '^C..EA.1D|^C..35.40|^C..27.95|^C..03.FA|'
                         '^B..C2.87|^B..C2.3A|^B..9B.68|^B..2A.0E|'
                         '^A..FF.70|^A..B1.E9|^A..91.B1|^A..7C.6A|^A..56.CC'
                         '^9..97.26|^9..9D.5D|^9..52.4A|^9..6A.77|^9..58.51'
                         '^8..F7.C7|^8..D0.4A|^8..C6.AB|^8..B2.34|^8..9E.68|^8..29.94|^8..17.EF|^8..04.FF|'
                         '^7..9A.54|^7..7E.2D|^7..5A.9E|^7..03.7E|'
                         '^6..55.E8|^6..3D.26|^6..12.36|'
                         '^5..A6.5C|^5..98.35|^5..96.30|^5..76.95|^5..23.8C|^5..09.59|'
                         '^4..F7.C0|^4..32.C8|^4..1C.12|^4..00.33|'
                         '^3..B7.4B|^3..9A.77|^3..91.8F|^3..3F.B3|^3..17.E1|'
                         '^2..BE.9B|^2..B0.01|'
                         '^1..C2.5A|^1..B7.F8|^1..98.7D|^1..62.D0|^1..33.BF|^1..13.31|'
                         '^0..95.2A|^0..90.D0|^0..90.64|^0..80.EE|^0..7E.64|^0..76.FF|'
                         '^0..26.44|^0..26.24|^0..24.D1|^0..24.17|'
                         '^0..1F.9F|^0..1E.69|^0..1D.68|^0..19.DF|^0..18.F6|^0..18.9B|^0..14.7F|^0..11.E3|^0..10.95|'
                         '^0..0E.80|^0..0E.50|^0..07.C3|^0..02.27')
