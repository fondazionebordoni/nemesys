...
TECHNICOLOR_MAC_REGEX = ('^F..94.E3|^F..91.14|^F..52.8D|^E..B9.E5|^E..88.5D|^D..B2.C4|^C..35.40|'
                         ...
                         '^0..02.27|^0..95.2A|^B..C2.3A|^7..7E.2D|^0..76.FF|^0..90.D0|^0..90.64|'
                         '^0..80.EE|^0..26.44|^0..26.24|^0..24.D1|^0..24.17|^0..1F.9F|^0..1E.69|'
                         '^0..1D.68|^0..19.DF|^0..18.F6|^0..18.9B|^0..14.7F|^0..11.E3|^0..10.95|'
                         '^0..0E.80|^0..0E.50|^0..07.C3')
